...
%		= {\color{blue} \SI{10.7}{\pico\tesla}},
	...
	\begin{align*}
		\vE(x, t) &= \Eo \cos(k x - \omg t) \,\yh, &
		\vB(x, t) &= \Bo \cos(k x - \omg t) \,\zh.
	\end{align*}	
	...
	Then we have
		\begin{align*}
		\vE(x, t) &= (\Eamp) \cos[ (\SI{1.32e7}{\radian\per\meter}) x - (\SI{3.97e15}{\radian\per\second}) t] \,\yh, \\
		\vB(x, t) &= (\SI{1.07e-11}{\tesla}) \cos[ (\SI{1.32e7}{\radian\per\meter}) x - (\SI{3.97e15}{\radian\per\second}) t] \,\zh.
	\end{align*}
\end{solution}
