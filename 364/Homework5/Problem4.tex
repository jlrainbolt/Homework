...
\sol{
	...
	From the first two equations here, all permutations of four like indices and of three like indices vanish.  That is,
	\al{
		R_{\tht \tht \tht \tht} &= - R_{\tht \tht \tht \tht} = 0, &
		R_{\tht \phi \phi \phi} &= R_{\phi \tht \phi \phi} = R_{\phi \phi \tht \phi} = R_{\phi \phi \phi \tht} = 0,
	}
	and likewise for $\tht \lrarrow \phi$.  The remaining possibilities are permutations of $\{ \tht, \tht, \phi, \phi \}$.  Applying Eq.~\refeq{symm}, we have
	\al{
		R_{\tht \tht \phi \phi} &= -R_{\tht \tht \phi \phi} = 0, &
		R_{\phi \phi \tht \tht} &= -R_{\phi \phi \tht \tht} = 0, &
		\ans{ R_{\tht \phi \phi \tht}\ }&\ans{ = -R_{\phi \tht \phi \tht} = -R_{\tht \phi \tht \phi} = R_{\phi \tht \tht \phi} \neq 0, }
	}
	as we wanted to show. \qed
}
