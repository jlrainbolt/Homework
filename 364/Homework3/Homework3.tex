...
\sol{
	...
	\al{
		...
		\Gam_{\tht \phi \phi} &= \frac{c_{\tht \phi \phi} + c_{\tht \phi \phi} - c_{\phi \phi \tht}}{2} = -\frac{1}{r \sin\tht}, \\[2ex]
		%
		%
		...
		\Gam_{\phi \tht \phi} &= \frac{c_{\phi \tht \phi} + c_{\phi \phi \tht} - c_{\tht \phi \phi}}{2} = \frac{1}{r \sin\tht}, \\
		%
	...
	\ans{\al{
		...
		\Gam_{\tht \phi \phi} &= -\frac{1}{r \sin\tht}, &
		\Gam_{\phi \tht \phi} &= \frac{1}{r \sin\tht}.
	}}%
...
\sol{
	\hl{I don't wanna do part (a)}
	
	Using the Mathematica notebook from Ref.~\cite{Hartle} with $r \to 1$, $\tht \to 2$, and $\phi \to 3$, we find
