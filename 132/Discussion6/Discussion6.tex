...
\begin{problem}
	...
	\begin{enumerate}
		\item In the circuit shown in \textbf{Fig.~Q25.14a}, the two bulbs $A$ and $B$ are identical.  Compared to bulb $A$, does bulb $B$ glow more brightly, just as brightly, or less brightly?  Explain your reasoning. \medskip
		\item Bulb $B$ is removed from the circuit and the circuit is completed as shown in \textbf{Fig.~Q25.14b}.  Compared to the brightness of bulb $A$ in \textbf{Fig.~Q25.14a}, does bulb $A$ now glow more brightly, just as brightly, or less brightly?  Explain your reasoning.
	\end{enumerate}
\end{problem}
\end{minipage}%
