...
\sol{
	...
	\al{
		...
		= \frac{1}{2} \int \ddpf \paren{ \anpdag \anp - \bpdag \bp - [\bp, \bpdag] } \\
		&= \ans{ \frac{1}{2} \int \ddpf \paren{ \apdag \ap - \bpdag \bp }. }
	}
	The particles associated with $\apdag \ap$ must have positive charge, since $\apdag \ap$ represents their number and has the same sign as the conserved charge.  Similarly, the particles associated with $\bpdag \bp$ must have negative charge.
}
