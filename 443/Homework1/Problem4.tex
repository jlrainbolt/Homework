...
\sol{
	...
	where we have used the Maclaurin series expansion for the exponential function~\cite{Maclaurin}.  The first term vanishes.  For the second term,
	\al{
...
%	In a classical system, quantum fluctuations do not occur, so we would expect both quantities to be zero.  The fluctuation in number density for this system, although 
}
