...
\sol{
	...
	where we have transposed the factors in the first term.  This is allowed because it is a c-number, and the sum of the matrix elements is the same if the matrices are transposed.  Then, integrating by parts, note that
	\eq{
...
\sol{
	...
	where we have applied Eq.~\refeq{sigthing}, taken the transpose of the second term.  Since $\cLDirac$ is a Lagrangian density, we may integrate this term by parts to obtain
	\eq{
