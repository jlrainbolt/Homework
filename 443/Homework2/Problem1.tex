...
\sol{
	...
	According to their Eq.~(3.33), $\psib$ transforms as $\psib \to \psib \Lamhi$; also, $\psi \to \Lamh \psi$.  The Lorentz transformation of the Dirac Lagrangian is then~\cite[p.~42]{Peskin}
	\al{
...
\sol{
	...
	which is zero only if $m$ is zero.
}
