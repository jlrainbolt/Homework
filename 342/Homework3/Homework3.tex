...
\begin{solution}
	...
	\eeq
	This is similar to the condition we saw for bound state energies in \ref{2.2}.  As displayed in Fig.~\ref{plot}, the $(n + 1)$th bound state appears when $z = n\pi + \pi / 2$.  From the definition of $z$ in \refeq{kapa}, there are $(n + 1)$ possible bound states when
	\beq
