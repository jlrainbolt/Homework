...
\begin{solution}
	...
	\beq
		H = \Ho + \lambda V.
	\eeq
	For the hydrogen atom, $\Ho$ is ninefold degenerate, so we need to find the eigenvalues of the full matrix $V$ given by \refeq{V2}.  Let $\Deli = e |\vE| \ao \mui$ denote the eigenvalues of $V$, where $\mu$ are the roots of the equation
	\beq
		0 = \det(V - \mu I) = 
	\eeq
\end{solution}
