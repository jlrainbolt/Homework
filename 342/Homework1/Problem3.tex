...
\begin{solution}
	...
	\beq
		\Deln = \lam V_{n n} + \lam^2 \sum_{k \neq n} \frac{|V_{n k}|^2}{\Eo_n - \Eo_k} + \cdots.
	\eeq
	For $n = 3$, up to second order we have
	\beq
		\Dele = \lam V_{3 3} + \lam^2 \left( \frac{|V_{3 1}|^2}{\Eoe - \Eod} + \frac{|V_{3 2}|^2}{\Eoe - \Eod} \right)
		= \lam^2 \frac{|\vq|^2 + |\vw|^2}{\Eoe - \Eod}
		= -\lam^2 \frac{|\vq|^2 + |\vw|^2}{\Eod - \Eoe}.
	\eeq
	Thus, we have
	\beq
		\Ee = \Eoe - \frac{|\vq|^2 + |\vw|^2}{\Eod - \Eoe}.
	\eeq
