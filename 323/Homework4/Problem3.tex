...
\sol{
	...
	A plot of the angular distribution of the radiation is shown in Fig.~\ref{3a}, in the $xz$ plane.
...
\sol{
	...
	A plot of the angular distribution of the radiation is shown in Fig.~\ref{3b}, in the $xz$ plane.
