...
\sol{
	...
	Then $\vJ_n(\vx, t) = \rhon(\vx, t) \,\vv(t)$, where $\rhon(\vx, t)$ are given by Eq.~\refeq{decomp}.  Using Eq.~\refeq{rhonpt},
	\al{
		\Jxn &= R \omgo \Re[ i e^{i \omgo t}]  \frac{1}{2\pi} \frac{q}{R^2} \del(r - R) \,\del(z) \,e^{i n \phi}, \\
		\Jyn &= R \omgo \Re[ i e^{i \omgo t}]  \frac{1}{2\pi} \frac{q}{R^2} \del(r - R) \,\del(z) \,e^{i n \phi}
	}
}
