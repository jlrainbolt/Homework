...
\sol{
	...
	\aln{
		...
		&= \int \paren{ -\frac{1}{16\pi} (\Fsmn \,\delFmn + \delFsmn \,\Fmn) - \frac{1}{c} \Jsm \,\delAm } \dqx, \label{delS1.a}
	}
	where we have discarded terms of $\order{(\delAm)^2}$.
	...
	\eq{
		\int \pdv{\,\delAsn}{\xsm} \pdv{\An}{\xm} \dqx = \bigg[ \delAsn \pdv{\An}{\xm} \bigg]_{-\infty}^\infty - \int \delAsn \pdv{\xsm} \pdv{\An}{\xm} \dqx
		= -\int \delAsn \,\partm \partsm \Asn \dqx,
	}
