...
%		\qimplies
	...
	To obtain the trajectory for short times, we note that $u = \Eo / c e \absvEo \ll 1$ implies that $\rpar \ll 1$.  Thus, we can Taylor expand Eq.~\refeq{traj} around $\rpar = 0$.  The Taylor series for $\cosh z$ is~\cite{Cosh}
	\eq{
