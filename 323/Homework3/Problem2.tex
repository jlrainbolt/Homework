...
\sol{
	...
	where $\vEpar'$ and $\vBpar'$ are parallel to $\vuu$, and $\vEperp'$ and $\vBperp'$ are perpendicular to $\vuu$.  This means that the particle's motion in this frame is the same as motion in a uniform, static magnetic field.  The particle's trajectory in a uniform magnetic field $\vB$ that points in the $y$ direction is found by modifying Jackson~(12.41):
	\eqn{pos2}{
		\vx(t) = \vxo + \vpar t \,\yh + i a (\zh - i \,\xh) e^{-i \omgB t},
	}
	...
	In $K'$, we have
	\aln{ \label{things2}
		\vomgB &= \frac{e c \vBperp'}{\Eo'}, &
		a &= \frac{c \pperp'}{e \abs{\vBperp'}}
		= \frac{\Eo \vperp'}{e c \abs{\vBperp'}},
	}
	where $\vperp'$ is the component of the particle's velocity perpendicular to the field in $K'$ and $\Eo'$ its initial energy in $K'$, with $\cE' = \Eo'$ since $\dv*{\cE'}{t} = 0$ in this frame by Jackson~(12.37).
	
	Then Eq.~\refeq{pos2} gives us
	\eq{
		\vx'(t') = \vxo' + \vpar' t' \,\yh + i a (\zh - i \,\xh) e^{-i \omgB t'}.
	}
	Taking the real part and letting $\vxo' = \vo$, we find the equations
	\aln{ \label{K'}
		z'(t') &= a \sin(\omgB t'), &
...
%		= \frac{c \ppar'}{\sqrt{m^2 c^2 + {\vp'}^2}} t',
	...
	Applying these to Eq.~\refeq{K'} and substituting for $\bet$ and $\gam$, we find the parametric equations
	{\color{blue} \al{
...
\sol{
	...
	\al{
		x''(t'') &= \frac{\sqrt{c^2 e^2 {\vEperp''}^2 \,{t''}^2 + {\Eo''}^2} - \Eo''}{e \abs{\vEperp''}} + \vox'' t'', \\[2ex]
		y''(t'') &= \frac{c \poy''}{e \abs{\vEperp''}} \sinh[-1](\frac{c e \abs{\vEperp''} t''}{\Eo''})
		= \frac{\Eo'' \voy''}{c e \abs{\vEperp''}} \sinh[-1](\frac{c e \abs{\vEperp''} t''}{\Eo''}), \\[2ex]
		z''(t'') &= \frac{c \poz''}{e \abs{\vEperp''}} \sinh[-1](\frac{c e \abs{\vEperp''} t''}{\Eo''})
		= \frac{\Eo'' \voz''}{c e \abs{\vEperp''}} \sinh[-1](\frac{c e \abs{\vEperp''} t''}{\Eo''}),
	}
	where $\vox''$, $\voy''$, and $\voz''$ are the $x''$, $y''$, and $z''$ components, respectively, of the particle's initial velocity in $K''$, and $\Eo''$ is the particle's initial energy in $K''$.
	
	We can transform back to the lab frame in a similar way as in Eq.~\refeq{boost2}, except now we boost by $\bet' = \absvB / \absvE$:
	\al{
		ct &= \gam' (c t'' + \bet' z''), &
		x &= x'', &
		y &= y'', &
	...
	{\color{blue} \al{
		t(t'') &= \sqrt{1 - \frac{\vB^2}{\vE^2}}^{\,-1} \brac{ t'' + \frac{\Eo'' \voz''}{c^2 e \abs{\vEperp''}} \sinh[-1](\frac{c e \abs{\vEperp''} t''}{\Eo''}) }, \\[2ex]
		x(t'') &= \frac{\sqrt{c^2 e^2 {\vEperp''}^2 \,{t''}^2 + {\Eo''}^2} - \Eo''}{e \abs{\vEperp''}} + \vox'' t'', \\[2ex]
		y(t'') &= \frac{\Eo'' \voy''}{c e \abs{\vEperp''}} \sinh[-1](\frac{c e \abs{\vEperp''} t''}{\Eo''}), \\[2ex]
		z(t'') &= \sqrt{1 - \frac{\vB^2}{\vE^2}}^{\,-1} \brac{ \frac{\Eo'' \voz''}{c e \abs{\vEperp''}} \sinh[-1](\frac{c e \abs{\vEperp''} t''}{\Eo''}) + \frac{\absvB}{\absvE} c t'' },
	}}%
	where $\vEperp''$ is given by Eq.~\refeq{K''}.
}