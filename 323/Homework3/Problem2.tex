...
\sol{
	...
	\al{
		x''(t'') &= \frac{\sqrt{c^2 e^2 {\vEperp''}^2 \,{t''}^2 + {\Eo''}^2} - \Eo''}{e \abs{\vEperp''}} + {v_0''}_{x''} t'', \\[2ex]
		y''(t'') &= \frac{c {\po''}_{y''}}{e \abs{\vEperp''}} \sinh[-1](\frac{c e \abs{\vEperp''} t''}{\Eo''})
		= \frac{\Eo {v_0''}_{y''}}{c e \abs{\vEperp''}} \sinh[-1](\frac{c e \abs{\vEperp''} t''}{\Eo''}), \\[2ex]
		z''(t'') &= \frac{c {\po''}_{z''}}{e \abs{\vEperp''}} \sinh[-1](\frac{c e \abs{\vEperp''} t''}{\Eo''})
		= \frac{\Eo {v_0''}_{z''}}{c e \abs{\vEperp''}} \sinh[-1](\frac{c e \abs{\vEperp''} t''}{\Eo''}),
	}
	where ${v_0''}_{x''}$, ${v_0''}_{y''}$, and ${v_0''}_{z''}$ are the $x''$, $y''$, and $z''$ components, respectively, of the particle's initial velocity in $K''$, and $\Eo$ is the particle's initial energy in $K''$.
