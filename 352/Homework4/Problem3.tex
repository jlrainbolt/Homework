...
\sol{
	...
	which has no degeneracy, since the $\pm$ sign splits the degenerate levels, and we have inserted factors of $c$.  In practice, however, we need only consider the positive energy levels, since the negative ones only contribute an overall constant.
