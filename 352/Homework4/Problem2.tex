...
\sol{
	...
	\eqn{thing2}{
		\Omg(\mu) = \frac{1}{g} \sumjs \Omgo[ \mu + 2(s - j) \muB B ]
	...
	Note that
	\al{
		\pdv{\Omg}{(\muB B)} &= \frac{1}{g} \sumjws \pdv{\Omgo(\mu)}{\muj} \pdv{\muj}{(\muB B)}
		= \frac{1}{g} \sumjws 2(s - j) \pdv{\Omgo(\mu)}{\muj}, \\
		\pdv[2]{\Omg}{(\muB B)} &= \frac{1}{g} \sumjws 2(s - j) \pdv[2]{\Omgo(\mu)}{\muj} \pdv{\muj}{(\muB B)}
		= \frac{1}{g} \sumjws 4 (s - j)^2 \pdv[2]{\Omgo(\mu)}{\muj},
	}
	so
	\al{
		\brac{ \pdv{\Omg}{(\muB B)} }_{\muB B = 0} &= \frac{1}{g} \sumjws 2(s - j) \brac{ \pdv{\Omgo(\mu)}{\muj} }_{\muB B = 0}
		= \frac{1}{g} \sumjs 2(s - j) \pdv{\Omgo(\mu)}{\mu}
		= 0, \\[1.5ex]
		\brac{ \pdv[2]{\Omg}{(\muB B)} }_{\muB B = 0} &= \frac{1}{g} \sumjws 4 (s - j)^2 \brac{ \pdv[2]{\Omgo(\mu)}{\muj} }_{\muB B = 0}
	...
	\eq{
		\Omg(\mu) \approx \Omgo(\mu) + \frac{4 \muB^2 B^2}{g} \pdv[2]{\Omgo(\mu)}{\mu} \sumjs (s - j)^2.
	}
	
	The magnetic moment of the gas is $M = -(\pdv*{\Omg}{B})_{T, V, \mu}$~\cite[p.~172]{Landau2}.  Here,
	\eq{
		M = -\frac{8 \muB^2 B}{g} \pdv[2]{\Omgo(\mu)}{\mu} \sumjs (s - j)^2.
	}
	According to p.~2 of lecture 12, the paramagnetic susceptibility is defined $\chi = (\pdv*{M}{B}) / V$.  Then
	\eq{
		\chi = -\frac{8 \muB^2}{g V} \pdv[2]{\Omgo(\mu)}{\mu} \sumjs (s - j)^2
		= \frac{8 \muB^2}{g V} \paren{ \pdv{N}{\mu} }_{T, V} \sumjs (s - j)^2,
	}
	...
	where $m$ is the mass of each atom.  So
	\eq{
		\chi = \frac{8 \muB^2}{g V} \pdv{\mu}(\frac{g V}{6\pi^2 \hbar^3} (2 m \mu)^{3/2}) \sumjs (s - j)^2
		= \frac{3}{2} \frac{8 \muB^2}{g V} \frac{g V}{6\pi^2 \hbar^3} \sqrt{2^3 m^3 \mu} \sumjs (s - j)^2
		= \ans{ \frac{4 \muB^2}{\pi^2 \hbar^3}  \sqrt{2 m^3 \mu} \sumjs (s - j)^2. }
	}
	\vfix
}