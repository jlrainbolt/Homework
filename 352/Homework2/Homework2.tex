...
\sol{
	...
	\eq{
		...
		\qimplies
		Z = \frac{1}{N!} [ 4\pi T m^2 c \,K_2(\bet mc^2) ]^N,
	}
	assuming the gas molecules are indistinguishable.  It is easier to work with $\ln Z$.  Taking the ultra-relativistic limit,
	\eq{
		\limuo \ln Z = \limuo N \ln(4\pi \frac{T}{c^3} m^2 c \,K_2(\bet mc^2)) - \ln N!
	}
}
