...
\begin{solution}
	...
	\beq
		\Ylm \propto \frac{1}{\sin^m{\tht}} \dv[l - m]{}{(\cost)} (1 - \coswt)^l.
	\eeq
	For $m = 0$,
	\beq
	...
	For $m = \pm 2$,
	\beq
		Y^l_{\pm 2} \propto \frac{1}{\sinwt} \sinwt \dv[l -2]{}{(\cost)} (1 - \coswt)^l.
	\eeq
	Plugging in $l = 2$,
	\beq
		Y^2_{\pm 2} \propto \frac{1}{\sinwt} \dv[0]{}{(\cost)} (1 - \coswt)^2 = \frac{\sin^4{\tht}}{\sinwt} = \sinwt.
	\eeq
