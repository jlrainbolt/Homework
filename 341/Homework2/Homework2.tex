...
\begin{solution}
	...
	\end{equation}
	\hl{????}
%	Let $t' = -\infty$ as suggested.  Evaluating the expectation values,
%	\begin{align}
%		\evHomi &= \ev{\Ho}{\Psi(t')} = \iint \braket{\Psi(t')}{x} \mel{x}{\Ho}{x'} \braket{x'}{\Psi(t')} \dd{x} \dd{x'} \\
%		&= \iint \braket{\Psi(t')}{x} \mel{x}{\left( \frac{P^2}{2m} + \VX \right)}{x'} \braket{x'}{\Psi(t')} \dd{x} \dd{x'} \\
%		&= \frac{1}{2m} \iint \braket{\Psi(t')}{x} \mel{x}{P^2}{x'} \braket{x'}{\Psi(t')} \dd{x} \dd{x'} + \iint \braket{\Psi(t')}{x} \mel{x}{\VX}{x'} \braket{x'}{\Psi(t')} \dd{x} \dd{x'}
%	\end{align}
\end{solution}
