...
\begin{solution}
	...
	\begin{enumerate} \label{a}
		...
		\item Applying \refeq{pket} and \refeq{pbra},
			\begin{align}
		...
		\end{align}
		where in going to \refeq{res1e} we have used \refeq{pket} and \refeq{pbra}.  Using a similar procedure for the second term of the left-hand side of (e),
		\begin{align}
		...
		\end{align}
		Adding the results of \refeq{res1} and \refeq{res2},
		\begin{align}
