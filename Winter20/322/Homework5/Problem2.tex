...
\begin{solution}
	...
	and then
	\beq
		\vEq\tx = \qq \frac{R \omg^2}{c^2 r} \left[ \cos(\omg t - \frac{\omg r}{c}) (\cos\tht \cos\vph \,\thh - \sin\vph \,\phh) + \sin(\omg t - \frac{\omg r}{c}) (\cos\tht \sin\vph \,\thh + \cos\vph \,\phh) \right].
	\eeq
	Applying \refeq{lorentz} with $\vv_2 = 0$, we have
	\begin{align*}
		\vF\tx &= \qw \vEq \\
