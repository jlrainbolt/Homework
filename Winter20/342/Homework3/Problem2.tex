...
\begin{solution}
	...
	or
	\beq
		\left\{ \frac{\hbar^2}{2 m} \left[ -\frac{1}{r^2} \pdv{r} \left( r^2 \pdv{r} \right) + \frac{l (l + 1)}{r^2} \right] + V(r) \right\} \Rl(r) = \El \, \Rl(r).
	\eeq
...
\begin{solution}
	...
	\beq
		\alp = \sqrt{\frac{2m (\Vo - \abs{E})}{\hbar^2}},
	\eeq
	\clearpage
	...
	\beqn \label{range}
		\frac{\pi}{2} \leq \sqrt{\frac{2 m \Vo a^2}{\hbar^2}} < \frac{3\pi}{2}
		\qimplies
		\frac{\pi^2 \hbar^2}{8 m a^2} \leq \Vo < \frac{9\pi^2 \hbar^2}{8 m a^2}.
	\eeqn
	...
	and that
	\beq
		A + B = \frac{2 k \kap^3 a - \kap^3 \sin 2ka + 2 k^3 e^{-2 \kap a}}{4 \kap^3 k^3}.
	\eeq
	Then the probability is
	\beq
		P(r > a) = \frac{e^{-2 \kap a}}{2 \kap^3} \frac{4 \kap^3 k^3}{2 k \kap^3 a - \kap^3 \sin 2ka + 2 k^3 e^{-2 \kap a}}
		= \frac{k^3 e^{-2 \kap a}}{k \kap^3 a - \kap^3 \sin ka \cos ka + k^3 e^{-2 \kap a}}.
	\eeq
	...
	\beq
		P(r > a) = \frac{k \kap^2 \sin^2 ka}{k \kap^3 a - \kap^3 \sin ka \cos ka + k \kap^2 \sin^2 ka}
		= \frac{k \sin^2 ka}{k \kap a + k \sin^2 ka - \kap \sin ka \cos ka}.
	\eeq
	\vfix
\end{solution}
