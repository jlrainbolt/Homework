...
\sol{
	...
	\al{
		\Re[\epsomg] &\approx 1 - \frac{\omgp^2}{1 / \tau^2}
		\approx 0, &
	...
	Then, since $\Im[\eps]$ is small,
	\eq{
		N = \sqrt{ -\frac{\omgp^2}{\omg^2} + i \frac{\omgp^2}{\tau \omg^3} }
		= i \frac{\omgp}{\omg} \sqrt{ 1 - \frac{i}{\tau \omg} }
		\approx i \frac{\omgp}{\omg} \paren{ 1 - \frac{i}{2 \tau \omg} }
		= \frac{\omgp}{2 \tau \omg^2} + i \frac{\omgp}{\omg}.
	}
	Clearly $\abs{N} \gg 1$.  Then we can Taylor expand Eq.~\refeq{R} for large $\abs{N}$:
	\eq{
		R = \frac{N - 1}{1 + N} \frac{\Ns - 1}{1 + \Ns}
		\approx \paren{ 1 - \frac{2}{N} } \paren{ 1 - \frac{2}{\Ns} }
		\approx 1 - 2 \paren{ \frac{1}{N} + \frac{1}{\Ns} }
		= 1 - 2 \frac{N + \Ns}{\abs{N}^2}
		= 1 - 2 \frac{2 \Re[N]}{\abs{N}^2}.
	}
	Then
	\eq{
		R = 1 - 2 \frac{\omgp / \tau \omg^2}{\omgp^2 / 4 \tau^2 \omg^4 + \omgp^2 / \omg^2}
		\approx 1 - 2 \frac{\omgp / \tau \omg^2}{\omgp^2 / \omg^2}
		= \ans{ 1 - \frac{2}{\omgp \tau} }
	}
	as desired. \qed
