...
\sol{
	...
	Feeding this into Eq.~\refeq{thing2a}, we can change the limits of integration to $(-\infty, \kF)$:
	\eqn{thing2a2}{
		g^2 \int \frac{\ddkp}{(2\pi)^3} \frac{\nkp}{(\epsk - \epskp)^2 - \omgD^2} = g^2 \intnikF \frac{\ddkp}{(2\pi)^3} \frac{1}{(\epsk - \epskp)^2 - \omgD^2}.
	}
	...
	\eq{
		g^2 \intnikF \frac{\ddkp}{(2\pi)^3} \frac{1}{(\epsk - \epskp)^2 - \omgD^2} = g^2 \intniepsF \ddepsp \frac{\Nepsp}{(\epsk - \epskp)^2 - \omgD^2}.
	}
	In the approximation $\epsF \approx \mu$, we finally have
	\eq{
