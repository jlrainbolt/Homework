...
\sol{
	...
	\aln{
%		N &= \ubpp [ \lsl \gamm \lsl - \lsl \gamm y \qsl + \lsl \gamm z \psl + \lsl \gamm \me + (1 - y) \qsl \gamm \lsl - (1 - y) \qsl \gamm y \qsl + (1 - y) \qsl \gamm z \psl + (1 - y) \qsl \gamm \me \notag \\
%		&\hspace{5em} \phantom{=\ } + z \psl \gamm \lsl - z \psl \gamm y \qsl + z^2 \psl \gamm \psl + z \psl \gamm \me + \me \gamm \lsl - \me \gamm y \qsl + \me \gamm z \psl + \me^2 \gamm ] \up
...
%	}
	We know from Eqs.~\refeq{Gam} and \refeq{Z1} that we only care about terms in Eq.~\refeq{thing1a} that are linear in $\gamm$.  So the terms in Eq.~\refeq{N2} reduce to
	\al{
		\lsl \gamm \lsl &= (2 \ellm - \gamm \lsl) \lsl
		= 2 \ellm \elln \gamsn - \gamm \lsl \lsl
		\to \frac{2}{d} \ell^2 \gmn \gamsn - \gamm \ell^2
		= \frac{2 - d}{d} \ell^2 \gamm,
		\\[1ex]
		...
		= (\psl' - \psl) \gamm \me
		\to (\me - \psl) \gamm \me
		= \me^2 \gamm - 2 \me \pmu + \me \gamm \psl
		\to 2 \me^2 \gamm,
		\\[1ex]
		...
		\to \gamm \me,
		\\[1ex]
		\psl \gamm \qsl &= (2 \pmu - \gamm \psl) \qsl
		\to -\gamm \psl \qsl
		= -2 \gamm p \cdot q + \gamm \qsl \psl
		\to -2 \gamm p \cdot q + \gamm (\psl' - \psl) \me
		\to \gamm q^2 + \me \gamm \psl' - \me^2 \gamm \\
		&= \gamm q^2 + \me (2 {\pmu}' - \psl' \gamm) - \me^2 \gamm
		\to \gamm q^2 + 2 \me {\pmu}' - 2 \me^2 \gamm
		\to \gamm q^2 - 2 \me^2 \gamm,
	}
	where we have used
	\eq{
	...
	where we have set $q^2 = 0$ as per Eq.~\refeq{Gam}.
}
