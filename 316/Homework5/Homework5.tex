...
\begin{problem}
	...
	\begin{align}
		&\intr \psi \pdv[2]{\psi}{x} \dd{x} \dd{y}, \label{2bfirst} \\
...
Using the results of problem~\ref{2}, show that the variation generated by going from a solution $\uo$ to $\uo + \eps\psi$ has the form
	\beq
		\dS = \eps \intt \intr \left(\rho \utt - \kaq \lapw u \right) \psi \dd{x} \dd{y} \dd{t} + \eps \intt \intdr \left( \Pu \psi + \Mu \pdv{\psi}{n} \right) \dlt.
	\eeq
	Specify $\Pu$ and $\Mu$.
\end{problem}

\begin{solution}
	Define $\Ld$ as the integrand in \refeq{action3}, and note that $\Ld = , and $\psi = \psi(x, y, t)$ as some variatoin of $u$.  In general,
	\beq
		\dS = \epsilon \intt \intr \left[ \left( \pdv{\Ld}{u} - \pdv{}{x} \pdv{\Ld}{\ux} - \pdv{}{y} \pdv{\Ld}{\uy} - \pdv{}{t} \pdv{\Ld}{\ut} \right) \psi + \pdv{}{x} \left( \pdv{\Ld}{\ux} \psi \right) + \pdv{}{y} \left( \pdv{\Ld}{\uy} \psi \right) + \pdv{}{t} \left( \pdv{\Ld}{\ut} \psi \right) \right] \dd{x} \dd{y} \dd{t},
	\eeq
	where $\eps \ll 1$.  For the \refeq{action3},
	\beq
		\dS = \epsilon \intt \intr \left[ \left( \pdv{\Ld}{u} - \pdv{}{x} \pdv{\Ld}{\ux} - \pdv{}{y} \pdv{\Ld}{\uy} - \pdv{}{t} \pdv{\Ld}{\ut} \right) \psi + \pdv{}{x} \left( \pdv{\Ld}{\ux} \psi \right) + \pdv{}{y} \left( \pdv{\Ld}{\uy} \psi \right) + \pdv{}{t} \left( \pdv{\Ld}{\ut} \psi \right) \right] \dd{x} \dd{y} \dd{t}
	\eeq
\end{solution}
